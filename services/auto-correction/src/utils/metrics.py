...
def get_evals(preds: List[str], sources: List[str], targets: List[str], is_lower=False) -> Tuple[int, ...]:
    """
...
def get_total_words(corr2corr: int, corr2incorr: int, incorr2corr: int, incorr2incorr: int) -> int:
    return corr2corr + corr2incorr + incorr2corr + incorr2incorr

def get_word_accuracy(corr2corr: int, corr2incorr: int, incorr2corr: int, incorr2incorr: int) -> float:
    return (corr2corr + incorr2corr) / (corr2corr + corr2incorr + incorr2corr + incorr2incorr)